    ...
    def find_best_lag(self, target_code, k, offset_month):
        ...
        for lag in range(1, max_lag + 1):
            ...
            for i in range(60 // offset_month):
                ...
                _, mape = self.train_predict_svr(train_data, test_data, target_code, additional_vars)
...
for i in range(60 // offset_month):
    ...
    # Predict using SVR
    predictions, mape = DH.train_predict_svr(train_data, test_data, target_code, additional_vars=vars)
    mape_values.append(mape)
